...
const RestBarSetting = ({ t, open = false, closeModal = () => {} }) => {
        ...
        <div className={clsx(style.Body)}>
          <div className={clsx(style.Left)}>
            ...
            <div style={{ marginTop: '10px' }}>
              <span className={clsx('font-heading-small')}>15 min work, 45 min rest</span>
            </div>

            <div style={{ marginTop: '10px' }}>
              <div>
                <span className={clsx('font-binary')}>It feels like 109°F | HEAT STRESS RISK</span>
              </div>
              <div>
                <Button
                  size={'xs'}
            ...
            <div className={clsx(style.ToggleWrapper)}>
              ...
              <Toggle on={true} titleOn="indoor" titleOff="outdoor" />
            </div>
            ...
            <div style={{ marginTop: '25px' }}>
              ...
              />
              <span className={clsx('font-heading-small')}>&nbsp;&nbsp;°F</span>
            </div>
            ...
            <div style={{ marginTop: '25px' }}>
              ...
              />
              <span className={clsx('font-heading-small')}>&nbsp;&nbsp;% rel. humidity</span>
            </div>
          </div>
          ...
          <div className={clsx(style.Right)}>
            <div className={clsx(style.Row)}>
              <div className={clsx(style.RowHeader)}>
                <span className={clsx('font-heading-small')}>Clothing</span>
              </div>
