          ...
          <div className={clsx(style.Icons)}>
            <img
              className={clsx(
                ...
                style.GoEndIcon,
                style.Reverse,
                firstPage ? style.Disabled : style.Active
              )}
              src={firstPage ? goEndDisabledIcon : goEndIcon}
              alt="go end icon"
            ...
            <img
              ...
              src={firstPage ? goNextDisabledIcon : goNextIcon}
              alt="go next icon"
            ...
            <img
              className={clsx(
                style.Icon,
                style.GoNextIcon,
                lastPage ? style.Disabled : style.Active
              )}
              src={lastPage ? goNextDisabledIcon : goNextIcon}
              alt="go next icon"
            ...
            <img
              ...
              src={lastPage ? goEndDisabledIcon : goEndIcon}
              alt="go end icon"
