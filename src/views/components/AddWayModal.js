  ...
  return (
    <div className={`modal ${show ? 'd-block' : 'd-none'}`} style={{ padding: '65px' }}>
      ...
      <div className="modal-header">
        <span className="add-way-modal-header text-white">{t('add way header')}</span>
      </div>

      <div className="modal-subheader mt-10">
        <span className="font-binary text-white">{t('add way description')}</span>
      </div>
      ...
      <div className="modal-body mt-60">
        <div className="d-flex justify-center tap-area">
          ...
          <div className={`ml-40 cursor-pointer tap`} style={{ background: '#212121' }}>
