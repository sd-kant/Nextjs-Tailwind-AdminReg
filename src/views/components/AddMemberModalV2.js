          ...
          <div className={clsx(style.User)}>
            ...
            <div className={clsx(style.UserRow)}>
              <div className="d-flex flex-column">
                ...
                {touched?.user && touched.user?.email && errors?.user && errors.user?.email && (
              ...
              <div className={clsx(style.SelectWrapper, 'd-flex')}>
                <div className="d-flex flex-column">
                  ...
                  {touched?.user && touched.user?.job && errors?.user && errors.user?.job && (
                ...
                <div className={clsx('d-flex flex-column')}>
                  ...
                  {touched?.user &&
                    touched.user?.userType &&
                    errors?.user &&
                    errors.user?.userType && (
                      <span className="font-helper-text text-error mt-10">
                        {errors.user.userType}
                      </span>
                    )}
              ...
              <div>
                ...
                <CustomPhoneInput
                  ...
                  onChange={(value, countryCode) =>
                    setFieldValue('user.phoneNumber', { value, countryCode })
                  }
                />
                {touched?.user &&
                touched.user?.phoneNumber &&
                errors?.user &&
...
export default withTranslation()(connect(mapStateToProps, null)(EnhancedForm));
