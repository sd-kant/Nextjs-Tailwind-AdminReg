              ...
              <div className={clsx(style.AuthorTxt)}>
                {
                  newsDetail?.authorName && (
                      <Link to={'/news/author?id=' + (newsDetail?.authorId ?? '')}>by {newsDetail?.authorName ?? ''}</Link>
                  )
                }
...

                {
                  newsDetail?.categoryNames && (
                      <Link to={'/news/author?id=' + (newsDetail?.authorId ?? '')}> &nbsp; | &nbsp;{newsDetail?.categoryNames ?? ''}</Link>
                  )
                }
              </div>
              {
                newsDetail?.thumbnail && (
                    <img src={newsDetail?.thumbnail} className={clsx(style.ThumbnailImg)} alt='thumbnail' />
                )
              }
              {
                newsDetail?.content &&
                <div className={clsx(style.NewsContainer)} dangerouslySetInnerHTML={{__html: newsDetail?.content}} />
              }
            </div>
