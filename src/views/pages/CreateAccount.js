...
const FormPhoneVerification = lazy(() =>
  import('../partials/create-account/FormPhoneVerification')
);
    ...
    <div className="form-main">
      ...
      <Suspense fallback={<Loader />}>
        <Routes>
          ...
          <Route path="/password-v2" element={<FormPassword navigate={navigate} {...props} />} />

          {!!token && <Route path="/name" element={<FormName navigate={navigate} {...props} />} />}
          {!!token && (
            <Route
              path="/phone-register"
              element={<FormPhoneRegister navigate={navigate} {...props} />}
            />
          )}
          {!!token && (
            <Route path="/phone-verification" element={<FormPhoneVerification {...props} />} />
          )}
          {!!token && (
            <Route path="/gender" element={<FormGender navigate={navigate} {...props} />} />
          )}
          {!!token && <Route path="/dob" element={<FormBirth navigate={navigate} {...props} />} />}
          {!!token && <Route path="/unit" element={<FormUnit navigate={navigate} {...props} />} />}
          {!!token && (
            <Route path="/height" element={<FormHeight navigate={navigate} {...props} />} />
          )}
          {!!token && (
            <Route path="/weight" element={<FormWeight navigate={navigate} {...props} />} />
          )}
          {!!token && (
            <Route path="/timezone" element={<FormTimezone navigate={navigate} {...props} />} />
          )}
          {!!token && (
            <Route path="/workLength" element={<FormWorkLength navigate={navigate} {...props} />} />
          )}
          {!!token && (
            <Route path="/startWork" element={<FormStartWork navigate={navigate} {...props} />} />
          )}
          {!!token && (
            <Route
              path="/photoUpload"
              element={<FormPhotoUpload navigate={navigate} {...props} />}
            />
          )}
          {!!token && <Route path="/medical-initial" element={<FormInitial {...props} />} />}
          {/* medical questions */}
          {!!token && (
            <Route
              path="/medical/:order"
          ...
          {!!token && <Route path="/medical-complete" element={<FormComplete {...props} />} />}
