...
const FormConnectDevice = (props) => {
  ...
  return (
    <Form className={clsx(style.Wrapper)}>
      ...
      <div className={clsx(style.DeviceWrapper)}>
        ...
        <p className={clsx(style.DeviceIDExplanation)}>
          {t("device id explanation")}
        </p>
      </div>
      ...
      <div className='mt-80'>
        <div>
          <button
            className={`button ${values['deviceId'] ? "active cursor-pointer" : "inactive cursor-default"}`}
