    ...
    <div className="form-group mt-57">
      <div>
        ...
        <div className="mt-28 form-header-medium">
          <span className="font-header-medium d-block">{t('upload description')}</span>
        </div>
      ...
      <div className="mt-80 form-header-medium">
        <span className="font-binary mt-8"></span>
      </div>
    </div>
  );
};
...
export default connect(null, mapDispatchToProps)(withTranslation()(FormUpload));
