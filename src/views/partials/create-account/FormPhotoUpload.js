...
const FormPhotoUpload = (props) => {
  ...
  return (
    <div className="form-group mt-57">
      ...
      <div className="mt-80">
        <button className={`button active cursor-pointer`} type={'submit'} onClick={submit}>
...
export default connect(null, mapDispatchToProps)(withTranslation()(FormPhotoUpload));
