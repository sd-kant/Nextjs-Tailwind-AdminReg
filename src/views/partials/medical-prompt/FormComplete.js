    ...
    <div className="form-group mt-57">
      <div>
        <div className="form-header-medium">
          <span className="font-header-medium d-block">{t('medical complete header')}</span>
        </div>

        <div className="mt-40">
          <span className="font-binary text-white">{t('medical complete description')}</span>
        </div>

        <div className="mt-80 d-flex justify-start align-center">
          <a href="https://apps.apple.com/app/id1631770130" target="_blank" rel="noreferrer">
            <img className="cursor-pointer" src={appStore} alt="app store button" />
          </a>
          <a
            href="https://play.google.com/store/apps/details?id=com.kenzen.v2"
            target="_blank"
            rel="noreferrer">
            <img className="cursor-pointer" src={googlePlay} alt="google play button" />
          </a>
        </div>
      </div>
