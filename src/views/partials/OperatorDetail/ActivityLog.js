...
const ActivityLog = ({ item, timezone }) => {
  ...
  return (
    <>
      <div className={clsx('tw-grid tw-grid-cols-12 md:tw-mt-1 tw-items-center tw-gap-2')}>
        <div
          className={clsx('tw-overflow-hidden tw-text-ellipsis tw-col-span-12 md:tw-col-span-6')}>
          <div
            className={clsx(
              'font-binary',
        ...
        <div
          className={clsx(
            'tw-col-span-5 md:tw-col-span-3',
            item.type !== 'Alert' ? 'tw-hidden md:tw-block' : null
          )}>
          <div className="tw-grid tw-grid-cols-2 lg:tw-grid-cols-2 tw-gap-2">
            <div
              className={clsx(
                'font-binary tw-col-span-1 tw-m-auto',
                'tw-flex tw-justify-center tw-w-full md:tw-w-[60px] tw-h-[40px] tw-rounded-[8px] tw-text-app-white tw-bg-app-ts tw-items-center'
              )}>
              <img
      ...
      <Divider className="tw-my-2 tw-opacity-5 md:tw-hidden" />
    </>
  );
};
