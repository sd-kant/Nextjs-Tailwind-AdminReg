...
const NewsProviderDraft = (
  ...
  React.useEffect(() => {
    const promises = [
      queryCategories(),
      queryNewsBlog(keyword, location?.pathname === '/news' ? page : 1, categoryId ? NEWS_RECENT_PAGINATION : NEWS_PAGINATION, categoryId)
    ];
